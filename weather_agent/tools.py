"""Weather Agent — tool functions (no ADK dependency)."""
...
def geocode_city(city_name: str) -> dict:
    """Resolve a city name to latitude/longitude coordinates via Open-Meteo Geocoding.
...
def get_current_weather(latitude: float, longitude: float) -> dict:
    """Fetch current weather conditions for given coordinates via Open-Meteo.
...
def get_forecast(latitude: float, longitude: float, days: int = 5) -> dict:
    """Fetch a multi-day daily weather forecast for given coordinates via Open-Meteo.
